...
class USPSAdressValidation(models.TransientModel):
    ...
    def default_get(self, fields_list):
        ...
        if active_id:
            ...
            res.update({
                ...
                'original_state': partner_obj.state_id and partner_obj.state_id.code or " ",
                'original_country': partner_obj.country_id and partner_obj.country_id.name or " "
    ...
    def set_valid_address(self, res, valid_address):
        ...
        if address_dict:
            res.update({
                ...
                'street2':  "" if address_dict.get('Address2') == 'FALSE' else address_dict.get('Address2'),
                ...
                "address_result": valid_address.get('AddressCleansingResult') or " "
            })
    ...
    def accept_validate_address(self):
        ...
        if active_id:
            ...
            state_id = self.env['res.country.state'].search([('code', '=', self.state),
